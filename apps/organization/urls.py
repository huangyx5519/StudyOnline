...
from .views import OrgView,OrganizationHomeView,OrganizationCourseView,OrganizationDescView,OrganizationTeacherView, \
...
urlpatterns = [
    ...
    url(r'^org_teacher/(?P<org_id>\d+)/$', OrganizationTeacherView.as_view(), name="org_teacher"),
    #
    #
    # 机构收藏
