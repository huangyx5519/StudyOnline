...
class Course(models.Model):
    course_org = models.ForeignKey(CourseOrganization, verbose_name=u"课程机构名称", null=True, blank=True)
    ...
    tag = models.CharField(choices=(("sf", "算法"), ("pt", "python语法"), ("ap", "应用"),("zn","人工智能"),("ot","其他")),default="ot", max_length=20, verbose_name=u"课程标签")
